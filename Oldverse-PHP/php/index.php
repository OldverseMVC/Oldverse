...
<div class="headline">
  ...
  <div style="padding: 15px 35px 15px 15px; margin-bottom: 20px; border: 1px solid #f1e9bc; border-radius: 4px; color: #8f8031; background-color: #f7edd9;"><strong>Warning:</strong> this website is probably a rehost, please tell the owner to stop making such boring.</div>
  ...
  <?php if(!LIMIT_COMMUNITY_CREATION || LIMIT_COMMUNITY_CREATION && $user['level'] >= 1){ ?><a href="/communities/create" class="button symbol create-button">Create community</a><?php } ?>
